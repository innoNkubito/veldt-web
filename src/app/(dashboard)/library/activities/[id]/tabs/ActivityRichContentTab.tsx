...
export default function ActivityRichContentTab({ activity, onSaved }: Props) {
  ...
  async function handleSave() {
    await updateActivity(activity.id, { pageContent: { sections: [section] } })
    setDirty(false)
    onSaved?.()
  }
  ...
  return (
    <div>
      <S.SectionCard>
        <S.SectionHeader>
          <S.SectionLabel>Activity Overview</S.SectionLabel>
        </S.SectionHeader>
        <S.SectionBody>
          <S.FieldGroup>
          ...
          <S.FieldGroup>
            ...
            <S.PhotoUploadZone htmlFor='activity-overview-upload'>
            ...
            <input id='activity-overview-upload' type='file' accept='image/*' multiple style={{ display: 'none' }} ref={fileRef} onChange={handleUpload} />
          </S.FieldGroup>
